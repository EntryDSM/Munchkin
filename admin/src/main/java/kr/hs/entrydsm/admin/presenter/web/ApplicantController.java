...
public class ApplicantController {
    ...
    public ApplicantsResponse getApplicants(Pageable page,
                                            @RequestParam(required = false, name = "receipt-code", defaultValue="") @Nullable Long receiptCode,
                                            @RequestParam(name = "is-daejeon") boolean isDaejeon,
                                            @RequestParam(name = "is-nationwide") boolean isNationwide,
                                            @RequestParam(required = false, name = "telephone-number", defaultValue="") @Nullable String telephoneNumber,
                                            @RequestParam(required = false, defaultValue="") @Nullable String name,
                                            ...
                                            @RequestParam(required = false, name = "is-printed-arrived", defaultValue="") @Nullable Boolean isPrintedArrived) {
